...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'landsat_patch_size_128_32_60_landsat8_sen' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc
        ...
        self.trained_model_path = '/home/mathilde/Bureau/asarhane/saved_models/20240812-2138_landsat_patch_size_128_predicition_stride_64_training_batch_size_32_training_steps_60_val_ratio_40_test_ratio_1_nodatavalueFixed0_noNdwi__numvalid_16.h5' # if set to None, it will use the most recent trained model
        ...
        self.prediction_batch_size = 64             # Depends on GPU memory, patch size and num parallel workers
