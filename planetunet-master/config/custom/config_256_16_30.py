...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'landsat_patch_size_256_predicition_stride_128_training_batch_size_16_training_steps_30_val_ratio_40_test_ratio_1_nodatavalueFixed0_noNdwi__numvalid_16' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc
