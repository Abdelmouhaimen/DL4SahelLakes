...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'landsat_patch_size_256_16_60_landsat8_sen' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc
        ...
        self.trained_model_path = '/home/mathilde/Bureau/asarhane/saved_models/20240819-1636_landsat_patch_size_256_predicition_stride_128_training_batch_size_16_training_steps_60_val_ratio_40_test_ratio_1_nodatavalueFixed0_noNdwi__numvalid_16.h5' # if set to None, it will use the most recent trained model
