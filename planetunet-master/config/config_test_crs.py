...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'testing_crs' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc

        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '../test_projection/poly'
        self.training_area_fn = 'rect.shp' #'testing_rectangles.shp' #
        self.training_polygon_fn = 'poly.shp' #'testing_polygons.shp' #

        # Path to training images
        self.training_image_dir = '../test_projection/' #'/home/mathilde/Bureau/asarhane/cnn/training_images/'
        ...
        self.channels_used = [True] #[False,True,True,True,False,False,False,False,True,True,True,True]  # add mndwi erase b8
