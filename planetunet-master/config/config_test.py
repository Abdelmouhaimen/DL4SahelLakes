...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'testing_pre' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc

        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '../testing_data2/'
        self.training_area_fn = 'testing_rectangles.shp' #'testing_rectangles.shp' #
        self.training_polygon_fn = 'testing_polygons.shp' #'testing_polygons.shp' #

        # Path to training images
        self.training_image_dir = '/mnt/md0/abduh/landsat8/images_mndwi_testing/' #'/home/mathilde/Bureau/asarhane/cnn/training_images/'
        ...
        self.preprocessed_dir = '/home/mathilde/Bureau/asarhane/preprocessed_frames/20240819-1022_testing_pre' #'/home/mathilde/Bureau/asarhane/cnn/other_files/preprocessed_frames/20230312-1032_modif16_rgb_b8b11b12_mndwi_60steps_val04_testdata/'              # if set to None, it will use the most recent preprocessing data
        ...
        self.trained_model_path = None #'/home/mathilde/Bureau/asarhane/saved_models/20240808-1612_landsat_patch_size_64_predicition_stride_32_training_batch_size_32_training_steps_50_val_ratio_40_test_ratio_1_nodatavalueFixed0_noNdwi__numvalid_16.h5' #'/home/mathilde/Bureau/asarhane/saved_models/20240725-1706_landsat_patch_size_128_predicition_stride_64_training_batch_size_16_training_steps_40_val_ratio_25_test_ratio_1_nodatavalueFixed0_noNdwi__numvalid_8_epoch_200.h5' #'/home/mathilde/Bureau/asarhane/saved_models/20240705-1152_landsat_patch_size_64_predicition_stride_32_training_batch_size_16_training_steps_30_val_ratio_40_test_ratio_1_nodatavalueFixed0_noNdwi_numvalid_16.h5' # if set to None, it will use the most recent trained model
        ...
        self.channels_used = [True,True,True,True,True,True,True,False] #[False,True,True,True,False,False,False,False,True,True,True,True]  # add mndwi erase b8
	# B2 B3 B4 B8(canal 9) B11(canal 10) B12(canal 11) MNDWI (canal 12)
        #self.channels_used = [False,False,False,False,False,False,False,False,False,True,True]#,True]
        ...
        self.num_epochs = 1
        self.num_training_steps = 40
        self.num_validation_images = 3 
        ...
        self.prediction_batch_size = 32             # Depends on GPU memory, patch size and num parallel workers
        self.prediction_stride = 128               # stride = width -> no overlap, stride = width/2 -> 50 % overlap
