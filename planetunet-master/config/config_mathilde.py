...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = 'modif16_rgb_b8b11b12_mndwi_40steps_100e_04val_testdata_alpha08_all2020' #_no_predict_norm' #'s2_modif_training_data'                     # custom name for this run, eg resampled_x3, alpha60, new_train etc

        # ---------- PATHS -----------
        # Path to training areas and polygons shapefiles
        self.training_data_dir = '/home/mathilde/cnn/training_data_modif16_small/'
        ...
        self.training_image_dir = '/mnt/md0/mathilde/sentinel2/train/images_mndwi/' #'/home/mathilde/cnn/training_images/'

        # Output base path where all preprocessed data folders will be created
        self.preprocessed_base_dir = '/home/mathilde/cnn/other_files/preprocessed_frames/'
        ...
        self.preprocessed_dir = '/home/mathilde/cnn/other_files/preprocessed_frames/20230312-1032_modif16_rgb_b8b11b12_mndwi_60steps_val04_testdata/'              # if set to None, it will use the most recent preprocessing data

        # Path to existing model to be used to continue training on [optional]
        self.continue_model_path = None #'/home/mathilde/cnn/other_files/saved_models/'          # If set to None, a new model is created

        # Path where trained models and training logs will be stored
        self.saved_models_dir = '/home/mathilde/cnn/other_files/saved_models/'
        self.logs_dir = '/home/mathilde/cnn/other_files/logs/'
        self.test_dir = '/home/mathilde/cnn/other_files/tests/'

        # Paths to input images to be predicted
        self.to_predict_dir = '/mnt/md0/mathilde/sentinel2/2020/images_processed_good/' #'/mnt/md0/mathilde/sentinel2/images/' #'/home/mathilde/cnn/prediction_images/'#'/home/mathilde/cnn/training_images/' 
        ...
        self.predictions_base_dir = '/home/mathilde/cnn/output_predictions/'
        
        # Path to model to use for this prediction [optional]
        self.trained_model_path = None#'/home/mathilde/cnn/other_files/saved_models/20230307-2338_modif16_no_iaa_nosplit_8steps_b8b11b12.h5' # if set to None, it will use the most recent trained model

        # Path to prediction folder to be postprocessed
        self.postprocessing_dir = None #'/home/mathilde/cnn/output_predictions/20230224-2300_modif7_all_good_2020/'              # if set to None, it will run postprocessing on the last predictions
        ...
        self.channels_used = [False,True,True,True,False,False,False,False,True,True,True,True]  # add mndwi erase b8
	# B2 B3 B4 B8(canal 9) B11(canal 10) B12(canal 11) MNDWI (canal 12)
        ...
        self.prediction_batch_size = 1             # Depends on GPU memory, patch size and num parallel workers
        self.prediction_stride = 256               # stride = width -> no overlap, stride = width/2 -> 50 % overlap
